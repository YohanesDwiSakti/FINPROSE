    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 bg-white flex flex-col p-12 lg:p-24 overflow-y-auto">
        ...
        <div className="mt-auto pt-12 flex items-center justify-between">
          ...
          <button type="button" onClick={() => setModal({ title: 'Bantuan Cepat', description: 'Chat bantuan akan menghubungkan Anda dengan admin YDA LAW OFFICE & Partners untuk kendala login atau pendaftaran.' })} className="text-brand-black">
