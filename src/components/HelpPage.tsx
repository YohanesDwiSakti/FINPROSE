                  ...
                  <div className="px-8 pb-8 animate-in slide-in-from-top-2 duration-300">
                    ...
                    <div className="mt-4 flex items-center space-x-4">
                       ...
                       <div className="flex items-center space-x-2">
                          <button onClick={() => setModal({ title: 'Terima kasih', description: 'Masukan Anda membantu kami meningkatkan pusat bantuan YDA LAW OFFICE & Partners.' })} className="px-3 py-1 bg-brand-gray-50 rounded-lg text-[8px] font-bold uppercase tracking-widest hover:bg-brand-black hover:text-white transition-all">Ya</button>
